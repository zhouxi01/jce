...
public class CertificateUtils {
    ...
    { 
    	 ...
    	 String keyfile = "C:/Users/Administrator/Desktop/通用版2.0.15/keytool/keys/swjce.jks";
	...
	public static void main(String[] args) throws Exception {
		 ...
		 String keyfile = "D:/keys/swjce.jks";
		 String cerfile = "D:/keys/server.csr";
		
		 
//		 PrivateKey privatekey = getPrivateKey(keyfile, "swjce", "666666");
		 PublicKey publickey = getPublicKey(cerfile);


		 String input = "TestForVerify";
